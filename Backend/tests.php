    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="section-title">
                <i class="fa-solid fa-pencil" style="color: #3892ce; margin-right: 10px;"></i>
                Materials
            </div>
            ...
            <!-- Test Tabs -->
            <div class="test-tabs">
                <button class="active-test"><i class="fa-regular fa-file-lines"></i> Test 1</button>
                <button><i class="fa-regular fa-file-lines"></i> Test 2</button>
                <button><i class="fa-regular fa-file-lines"></i> Test 3</button>
            </div>
