...
<body>
    ...
    <div class="container">
        ...
        <main>
            ...
            <h2 class="growth-title" style="margin-bottom: 25px; color: #3892ce;">Test Papers</h2>
                ...
                <?php
                    ...
                    ?>
                        ...
                        <div class="no-notes">
                            ...
                            <h3>You don't have any Test papers yet</h3>
                            <p>Your downloaded test papers will appear here.</p>
                        </div>
